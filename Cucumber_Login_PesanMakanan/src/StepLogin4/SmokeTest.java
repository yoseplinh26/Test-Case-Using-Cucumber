...
public class SmokeTest {
	...
	@When("^I enter Wrong username and Invalid password$")
	public void I_enter_Wrong_username_and_Invalid_password() throws Throwable {
		driver.findElement(By.xpath("//*[@id=\"login-field\"]")).sendKeys("bunda33@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"password-login\"]")).sendKeys("bunda324");
