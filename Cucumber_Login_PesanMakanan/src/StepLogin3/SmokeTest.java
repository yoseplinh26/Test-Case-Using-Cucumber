...
public class SmokeTest {
	...
	@When("^I enter Wrong username and valid password$")
	public void I_enter_Wrong_username_and_valid_password() throws Throwable {
		driver.findElement(By.xpath("//*[@id=\"login-field\"]")).sendKeys("prisil33@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"password-login\"]")).sendKeys("prisill324");
